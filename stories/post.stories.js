...
storiesOf("Components/post", module)
  .add("single", () => (
    ...
    >
      <p>
        Jack Tar scurvy reef Corsair tack barque mutiny chase pinnace hempen
        halter. Plate Fleet Blimey chase guns belay Arr crow's nest hornswaggle
        long clothes hands Chain Shot. Squiffy marooned blow the man down
        yardarm keel lanyard bilge rat execution dock killick lass.
      </p>
      <p>
        Wench overhaul topgallant man-of-war strike colors hogshead keel crimp
        plunder reef.
      </p>
    </Post>
  ))
...
let html = (
  <div>
    <p>
      🎉 Let's get <a href="/#">started with</a> some hitchhiker's Guide to the
      Galaxy quotes, shall we!
    </p>

    <h2>Why, what did she tell you? 🙋</h2>
    <blockquote>I don't know, I didn't listen.</blockquote>
    <p>
      You know, it's at times like this, when I'm trapped in a Vogon airlock
      with a man from Betelgeuse, and about to die of <code>asphyxiation</code>{" "}
      in deep space that I really wish I'd listened to what my mother told me
      when I was young. 😖
    </p>
    <pre className="language-js">
      <code>console.log('click here to copy 💾 this script');</code>
    </pre>

    <h2>🚀 But the plans were on display...</h2>
    <blockquote>
      “But the plans were on display...” “On display? I eventually had to go
      down to the cellar to find them.” “That’s the display department.” “With a
      flashlight.” “Ah, well, the lights had probably gone.” “So had the
      stairs.” “But look, you found the notice, didn’t you?” “Yes,” said Arthur,
      ...
      Leopard.” Find more quotes at{" "}
      <a href="https://www.goodreads.com/quotes/tag/arthur-dent">
        GoodReads.com
      </a>
      .
    </blockquote>
    ...
    <ul>
      <li>It comes from a very ancient democracy, you see...</li>
      <li>You mean, it comes from a world of lizards?</li>
      <li>
        ...
        hate the lizards and the lizards rule the people." "Odd," said Arthur,
        "I thought you said it was a democracy." "I did," said Ford. "It is."
      </li>
      <li>
    ...
    <p>
      <strong>Intermission! ✋</strong> An{" "}
      <a href="https://en.wikipedia.org/wiki/Intermission">intermission</a> is
      where characters are deemed to continue acting during the interval from
      one act to another." However, intermissions are more than just{" "}
      <em>dramatic pauses</em> that are parts of the shape of a{" "}
      <em>dramatic structure</em>.
    </p>
    <ol>
      <li>
      ...
      <li>
        "You mean they actually vote for the lizards?" "Oh yes," said Ford with
        a shrug, "of course." "But," said Arthur, going for the big one again,
        "why?"
      </li>
      <li>
        "Because if they didn't vote for a lizard," said Ford, "the wrong lizard
        might get in. Got any gin?" "What?" "I said," said Ford, with an
        increasing air of urgency creeping into his voice, "have you got any
        gin?" "I'll look. Tell me about the lizards." Ford shrugged again.
      </li>
      <li>
        ...
        utterly wrong, but someone's got to say it." "But that's terrible," said
        Arthur.
      </li>
      <li>
        "Listen, bud," said Ford, "if I had one Altairian dollar for every time
        I heard one bit of the Universe look at another bit of the Universe and
        say 'That's terrible' I wouldn't be sitting here like a lemon looking
        for a gin.”
      </li>
    </ol>
    ...
    <p>
      <strong>📝 Code: Inline.</strong>
    </p>
    <code className="language-bash">
      sudo npm install -g gatsby-cli # Update the `npm` CLI client
    </code>
    <br />
    <code className="language-clojure">(def hello "world")</code>
    <br />
    ...
    <pre className="language-bash">
      <code>sudo npm install -g gatsby-cli # Update the `npm` CLI client</code>
    </pre>
    <br />
    <pre className="language-clojure">
      <code>
        (defn print-something [] (let [something '("do" " " "not" " " "panic!")]
    ...
    <p>
      ...
      <a
        href="https://curiousprogrammer.dev/blog/setting-up-my-environment-in-fedora"
        target="_blank"
      >
        post
      </a>
...
storiesOf("Layout/examples", module).add("post", () => (
  <PostPage
    slug="/blog/template"
    title="Don't Panic."
