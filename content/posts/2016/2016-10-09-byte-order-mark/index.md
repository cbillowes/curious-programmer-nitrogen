...
![Interpretation](/gifs/endianness.gif "Example of a 32-bit integer committed to memory differently for big-endian and little-endian")
...
![Interpretation](/gifs/bom.gif "The byte order mark for UTF-16 (big-endian and little-endian) and UTF-8")
