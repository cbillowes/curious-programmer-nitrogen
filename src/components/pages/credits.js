...
const CreditsPage = () => (
  <Layout className="credits-page" footer={true}>
    <ReadingPane heading="Credits & Resources">
      <div>
        <H2>Hosting</H2>
        <Credit to="https://netlify.com" title="Netlify">
          is an all-in-one workflow that combines global deployment, continuous
          integration and automatic HTTPS and is where I host my blog.
        </Credit>
      </div>
      ...
      <div>
        ...
        <Credit to="https://www.gatsbyjs.com/" title="Gatsby">
          is a React-based, GraphQL powered, static site generator. It is the
          super cool and conveniently generates my blog from markdown files.
          <ul>
            <li>
              <Anchor to="https://github.com/gatsbyjs/gatsby-starter-default">
                gatsby-starter-default
              </Anchor>
              is a boilerplate with some bells and whistles to help kick-off new
              Gatsby projects. This is the starter that I used for my blog.
            </li>
            <li>
              <Anchor to="https://fortawesome.com/">fortawesome</Anchor>
              builds and manages icons and typefaces in a single place, then
              serves them with a single line of code.
            </li>
            <li>
              <Anchor to="https://github.com/zenorocha/clipboard.js#readme">
                clipboard
              </Anchor>
              is a modern copy to clipboard library with no flash and gzipped to
              3kb.
            </li>
            <li>
              <Anchor to="https://github.com/gatsbyjs/gatsby/tree/master/packages/gatsby-plugin-sitemap#readme">
                gatsby-plugin-sitemap
              </Anchor>
            </li>
            <li>
              <Anchor to="https://www.gatsbyjs.org/packages/gatsby-plugin-robots-txt/">
                gatsby-plugin-robots-txt
              </Anchor>
            </li>
            <li>
              <Anchor to="https://github.com/Rulikkk/gatsby-remark-emoji#readme">
                gatsby-remark-emoji
              </Anchor>
              adds slack-style emoji to gatsby's markdown 🚀
            </li>
            <li>
              <Anchor to="https://github.com/gatsbyjs/gatsby/tree/master/packages/gatsby-remark-prismjs#readme">
            ...
            <li>
              <Anchor to="https://www.npmjs.com/package/gatsby-remark-responsive-iframe">
            ...
            <li>
              <Anchor to="https://github.com/ntwcklng/gatsby-remark-embed-youtube#readme">
                gatsby-remark-embed-youtube
              </Anchor>
            </li>
            <li>
              <Anchor to="https://github.com/weirdpattern/gatsby-remark-embed-gist#readme">
      ...
      <div>
        ...
        >
          is the emoji-list full of emojis, names, short codes, unicode and html
          entities that I reference.
        </Credit>
        <br />
        <Credit
      ...
      <div>
        ...
        <Credit to="https://pixlr.com/editor/" title="pixlr.com">
          is a cloud-based set of image tools and utilities, including a number
          of photo editors, a screen recorder browser extension, and a photo
          sharing service. The suite was intended for non-professionals, however
          the apps range from simple to advanced photo editing.
        </Credit>
        <br />
      ...
      <div>
        <Credit to="https://www.iubenda.com" title="iubenda">
          Attorney-level solutions to make your websites and apps compliant with
          the law across multiple countries and legislation.
        </Credit>
      </div>
    </ReadingPane>
  </Layout>
