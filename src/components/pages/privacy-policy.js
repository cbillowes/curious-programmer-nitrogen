...
const PrivacyPolicyPage = () => (
  <Layout className="privacy-policy-page" footer={true}>
    <ReadingPane heading="Privacy Policy">
      <div>
        <p>Latest update: December 28, 2018</p>

        <div>
          <p>
            <strong>curiousprogrammer.dev</strong> collects some Personal Data
            from its Users. The
            <Anchor to="https://www.iubenda.com/private/privacy-policy/621007?preview=true&amp;ifr=true&amp;height=800&amp;an=no">
              simplified Privacy Policy
            </Anchor>
            is available for you to quickly skim through it.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            Clarice Bouwer,{" "}
            <Anchor to="mailto:clarice@bouwer.dev">clarice@bouwer.dev</Anchor>.
          </p>
        </div>
          ...
          <ul>
            ...
            <li>
              ...
              <p>
                <b>Disqus</b>
                <br />
                Personal Data: Cookies, Usage Data and various types of Data as
        ...
        <div>
          ...
          <ul>
            <li>
              ...
              Note: Under some legislation the Owner may be allowed to process
        ...
        <div>
          ...
          <p>
            ...
            provide its Services, as well as for the following purposes: Content
          ...
          <ul>
            <li>
              ...
              <p>
                ...
                <Anchor to="https://www.google.com/intl/en/policies/privacy/">
                  Privacy Policy
                </Anchor>
                -
                <Anchor to="https://tools.google.com/dlpage/gaoptout?hl=en">
                  Opt Out
                </Anchor>
                .
              </p>
            ...
            <li>
              ...
              <p>
                ...
                -
                <Anchor to="https://help.disqus.com/customer/portal/articles/1657951">
                  Opt Out
                </Anchor>
                .
              </p>
