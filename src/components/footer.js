...
const Intro = () => {
  return (
    <div data-component="footer-intro-element">
      ...
      Built with
      <Anchor to="https://www.gatsbyjs.org">Gastby</Anchor>
      and other 
      <Anchor to="/credits">cool stuff</Anchor>.
    </div>
  )
}
...
const Social = () => {
  return (
    <SocialContainer data-component="footer-social-icons-element">
      <Anchor to="https://www.linkedin.com/in/cbouwer" title="LinkedIn" bland="true">
        <SocialIcon
      ...
      <Anchor to="https://twitter.com/cbillowes" title="Twitter" bland="true">
        <SocialIcon
      ...
      <Anchor to="https://github.com/cbillowes" title="GitHub" bland="true">
        <SocialIcon 
