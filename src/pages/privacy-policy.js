...
const PrivacyPolicyPage = () => (
  <Layout className="privacy-policy">
    ...
    <div data-page="privacy-policy">
      <H1>Privacy Policy</H1>
      <p>Latest update: December 28, 2018</p>

      <div>
        <p>
          <strong>curiousprogrammer.dev</strong> collects some Personal Data from its Users. The
      ...
      <div>
        ...
        <p>
          Clarice Bouwer, <Anchor to="mailto:clarice@bouwer.dev">clarice@bouwer.dev</Anchor>.
        </p>
      </div>
